...
EXCEL_PATH = os.path.join(PROJECT_ROOT, "My Library.xlsx")
BOOKS_JSON_PATH = os.path.join(PROJECT_ROOT, "data", "books.json")
BOOKS_JS_PATH = os.path.join(PROJECT_ROOT, "data", "books.js")
COVERS_DIR = os.path.join(PROJECT_ROOT, "data", "covers")
MANUAL_COVERS_DIR = os.path.join(PROJECT_ROOT, "data", "manual-covers")
